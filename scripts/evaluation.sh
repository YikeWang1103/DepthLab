...
python tests/eval_perf.py \
    --dumped_path '/mnt/nas/perception/yike/validation/dumped_file_v19.1.0_temp' \
    --process_mode 'post-processing' \
    ...
    --output_path '/mnt/nas/perception/yike/validation/dumped_file_v19.1.0_temp' \
    --max_range 10